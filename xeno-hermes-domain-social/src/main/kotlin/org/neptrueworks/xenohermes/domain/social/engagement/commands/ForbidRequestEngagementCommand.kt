...
import org.neptrueworks.xenohermes.domain.social.engagement.events.RequestEngagementForbiddenEvent
...
public final class ForbidRequestEngagementCommandHandler (
    ...
    public override fun handle(command: ForbidRequestEngagementCommand) {
        ...
        this.eventTrigger.raise(RequestEngagementForbiddenEvent.initialize(command));
