...
import org.neptrueworks.xenohermes.domain.social.engagement.events.RequestEngagementPermittedEvent
...
public final class PermitRequestEngagementCommandHandler(
    ...
    public override fun handle(command: PermitRequestEngagementCommand) {
        ...
        this.eventTrigger.raise(RequestEngagementPermittedEvent.initialize(command));
